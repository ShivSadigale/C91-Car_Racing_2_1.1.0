...
function my_keydown(e)
{
	...
	console.log(keyPressed);
		...
		if(car1_x > 700){
			...
			document.getElementById("game_status").innerHTML = "The First Car Won The Race, Well Done Champ!!!";
			
			}
		else if(car2_x > 700){

				console.log("car2 Won!")
				document.getElementById("game_status").innerHTML = "The Second Car Won The Race, Well Done Champ!!!";
